/**
 * Shortest Path Baseline for Path Ranking
 *
 * Ranks paths purely by their length (number of edges).
 * Shorter paths receive higher scores.
 *
 * This baseline serves as a simple comparison for Path Salience Ranking,
 * which considers information quality beyond just path length.
 */
 ...
 *
 * Returns all paths of minimum length, sorted by length ascending.
 * @param graph
 * @param startId
 * @param endId
 * @param traversalMode
