/**
 * NOVELTY: Ranking Difference Tests
 *
...
describe("NOVELTY: Ranking Difference Tests", () => {
	/**
	 * Novelty Claim: Path Salience Ranking ranks longer high-MI path
	...
	/**
	 * Novelty Claim: Path Salience Ranking shows low correlation with
	...
	/**
	 * Novelty Claim: Path Salience Ranking prefers quality over length
	...
	/**
	 * Novelty Claim: Length penalty still works for very long paths.
	 *
	...
	/**
	 * Novelty Claim: When all MI values are equal, Path Salience Ranking
	...
	/**
	 * Novelty Claim: Path Salience Ranking produces different rankings
