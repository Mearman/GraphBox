/**
 * CORRECTNESS: Early Termination Tests
 *
...
describe("CORRECTNESS: Early Termination Tests", () => {
	/**
	 * Correctness Claim: Algorithm with targetPathsPerPair config should complete.
	 *
	...
	/**
	 * Correctness Claim: Algorithm with N=3 seeds should complete with targetPathsPerPair config.
	 *
	...
	/**
	 * Correctness Claim: Without targetPathsPerPair, algorithm runs to frontier exhaustion.
	 *
	...
	/**
	 * Correctness Claim: targetPathsPerPair=undefined should be treated as no early termination.
	 *
	...
	/**
	 * Correctness Claim: Higher targetPathsPerPair allows more exploration.
	 *
