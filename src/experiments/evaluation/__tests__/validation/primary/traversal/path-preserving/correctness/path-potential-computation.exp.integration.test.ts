/**
 * CORRECTNESS: Path Potential Computation Tests
 *
...
describe("CORRECTNESS: Path Potential Computation Tests", () => {
	/**
	 * Correctness Claim: path_potential counts neighbours visited by OTHER frontiers.
	 *
	...
	/**
	 * Correctness Claim: path_potential=0 for nodes whose neighbours are only
	...
	/**
	 * Correctness Claim: path_potential increases as frontiers converge.
	 *
	...
	/**
	 * Correctness Claim: path_potential correctly handles multi-seed (N>2) scenarios.
	 *
