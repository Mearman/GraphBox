/**
 * NOVELTY: Entropy-Based Ordering Difference Tests
 *
...
describe("NOVELTY: Entropy-Based Ordering Difference Tests", () => {
	/**
	 * Novelty Claim: EGE expands nodes in different order than DegreePrioritised
	...
	/**
	 * Novelty Claim: On multi-type graphs, EGE produces different expansion
	...
	/**
	 * Novelty Claim: EGE's entropy-based ordering preserves path discovery
