/**
 * SIGNIFICANCE: Salience Coverage Tests
 *
...
describe("SIGNIFICANCE: Salience Coverage Tests", () => {
	/**
	 * Significance Claim: RSGE explores comparable nodes to other methods.
	 *
	...
	/**
	 * Significance Claim: RSGE produces comparable coverage to DegreePrioritised.
	 *
	...
	/**
	 * Significance Claim: RSGE maintains efficiency comparable to DegreePrioritised.
	 *
	...
	/**
	 * Significance Claim: RSGE works on uniform-degree graphs.
	 *
	...
	/**
	 * Significance Claim: RSGE scales with graph complexity.
	 *
	...
	/**
	 * Significance Claim: RSGE visits all hubs in multi-hub graphs.
	 *
