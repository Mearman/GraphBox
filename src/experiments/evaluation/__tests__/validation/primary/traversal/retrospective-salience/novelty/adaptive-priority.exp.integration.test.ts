/**
 * NOVELTY: Adaptive Priority Tests
 *
...
describe("NOVELTY: Adaptive Priority Tests", () => {
	/**
	 * Novelty Claim: RSGE produces similar node coverage as DegreePrioritised.
	 *
	...
	/**
	 * Novelty Claim: RSGE visits all reachable nodes.
	 *
	...
	/**
	 * Novelty Claim: RSGE shows similar discovery patterns to DegreePrioritised.
	 *
	...
	/**
	 * Novelty Claim: RSGE exhausts frontiers completely.
	 *
