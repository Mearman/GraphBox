/**
 * CORRECTNESS: Phase 2 Formula Compliance
 *
...
describe("CORRECTNESS: Phase 2 Formula Compliance", () => {
	/**
	 * Correctness Claim: RSGE explores all graph nodes like DegreePrioritised.
	 *
	...
	/**
	 * Correctness Claim: RSGE visits same nodes as DegreePrioritised.
	 *
	...
	/**
	 * Correctness Claim: RSGE produces valid discovery iterations.
	 *
	...
	/**
	 * Correctness Claim: RSGE discovers all leaves via frontier exhaustion.
	 *
	...
	/**
	 * Correctness Claim: RSGE has comparable iterations to DegreePrioritised.
	 *
