...
import type { TableRenderSpec } from "ppef/renderers/types";

/**
 * Method abbreviations for table display.
 * GraphBox-specific mapping from SUT IDs to short names.
 */
const METHOD_ABBREVIATIONS: Record<string, string> = {
	"degree-prioritised-v1.0.0": "DP",
	"standard-bfs-v1.0.0": "BFS",
	"frontier-balanced-v1.0.0": "FB",
	"random-priority-v1.0.0": "RP",
...
/**
 * Get method abbreviation for table display.
 * @param sutId - SUT identifier
 * @returns Abbreviated name
 */
const getMethodAbbreviation = (sutId: string): string => METHOD_ABBREVIATIONS[sutId] ?? sutId;
